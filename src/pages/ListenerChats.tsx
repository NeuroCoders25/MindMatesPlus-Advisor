...
export default function ListenerChats() {
  ...
  // Subscribe to accepted listener chats
  useEffect(() => {
    if (!currentUser) { setLoadingChats(false); return; }
  ...
  const displayName = selectedChat
    ? (selectedChat.nickName || selectedChat.userName || 'Unknown')
    : '';
    ...
    >
      ...
      <header>
        ...
        <p className="text-slate-500 mt-1">
          Active conversations with students you've accepted for listener support.
        </p>
      </header>
      ...
      <div className="flex gap-4" style={{ height: 'calc(100vh - 280px)', minHeight: '520px' }}>
        ...
        <div className="w-72 shrink-0 flex flex-col bg-white rounded-2xl border border-slate-200 overflow-hidden">
