...
export default function CaseDetailsModal({ isOpen, onClose, connection }: CaseDetailsModalProps) {
  ...
  const latestEmotionScore = userProfile.latestMlEmotionScore as number | undefined;
  const userStatus = userProfile.userStatus as string | undefined;

  const hasProfileSummary =
    !profileLoading &&
    (classificationLevel || depressionScore != null || latestEmotionScore != null || baselineCategory || userStatus);
              ...
              <div className="p-5 flex flex-col gap-4 flex-1">
                ...
                <div className="flex flex-col items-center gap-2.5 py-2">
                  ...
                  <div className="text-center">
                    <p className="font-bold text-slate-800">{connection.userName}</p>
                    <p className="text-xs text-slate-400 mt-0.5">{connection.userEmail}</p>
                  ...
                  <div className="bg-brand-50 rounded-xl p-3.5 border border-brand-100">
                    ...
                    <div className="space-y-2">
                      ...
                      {latestEmotionScore != null && (
                        <div className="flex items-center justify-between">
                          <span className="text-[10px] text-slate-500">Emotion Score</span>
                          <span className="text-[10px] font-bold text-slate-700">
                            {latestEmotionScore.toFixed(2)}
                          </span>
                        </div>
                      )}
                      {userStatus && (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400">
                      ...
                      <span className="font-semibold text-brand-500">{connection.userName}</span>
                    </p>
                  </div>
                </div>
                <button
                    ...
                    return (
                      ...
                      >
                        <div className={cn('max-w-[75%]', isAdvisor ? 'items-end' : 'items-start')}>
                          ...
                          >
                            {isAdvisor ? 'ADVISOR' : connection.userName.split(' ')[0].toUpperCase()}{' '}
